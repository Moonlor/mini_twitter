...
describe User do
  ...
  describe "when email address is already taken" do
  	before do 
  	  user_wth_same_email = @user.dup
      user_wth_same_email.email = @user.email.upcase
      user_wth_same_email.save
    end
  ...
  describe "when password is not present" do
  	before do
  	  @user = User.new(name: "EX", email: "EX@qq.com", password: " ", password_confirmation: " ")
  	end
